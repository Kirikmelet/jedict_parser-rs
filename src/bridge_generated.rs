...
use crate::jmdict::dict::JMDict;
use crate::jmdict::dict::JMDictEntry;
use crate::jmdict::dict::JMDictExample;
use crate::jmdict::dict::JMDictKanji;
use crate::jmdict::dict::JMDictReading;
use crate::jmdict::dict::JMDictSense;
use crate::jmdict::dict::JMDictSenseGloss;
use crate::jmdict::dict::JMDictSenseLangSource;
use crate::jndict::dict::JNDict;
use crate::jndict::dict::JNDictEntry;
use crate::jndict::dict::JNDictKanji;
use crate::jndict::dict::JNDictReading;
use crate::jndict::dict::JNDictTransDet;
use crate::jndict::dict::JNDictTranslations;
use crate::kanjidic2::dict::KD2Dict;
use crate::kanjidic2::dict::KD2DictCharCodePointValue;
use crate::kanjidic2::dict::KD2DictCharRadical;
use crate::kanjidic2::dict::KD2DictCharacter;
use crate::kanjidic2::dict::KD2DictDicNumber;
use crate::kanjidic2::dict::KD2DictHeader;
use crate::kanjidic2::dict::KD2DictMeaning;
use crate::kanjidic2::dict::KD2DictMisc;
use crate::kanjidic2::dict::KD2DictMiscVariant;
use crate::kanjidic2::dict::KD2DictQueryCode;
use crate::kanjidic2::dict::KD2DictRMGroup;
use crate::kanjidic2::dict::KD2DictReading;
use crate::kanjidic2::dict::KD2DictReadingMeaning;

// Section: wire functions

fn wire_parse_jmdict_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jmdict",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_jmdict(api_path))
        },
    )
}
fn wire_parse_jndict_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jndict",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_jndict(api_path))
        },
    )
}
fn wire_parse_kanjidic2_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_kanjidic2(api_path))
        },
    )
}
fn wire_parse_jmdict_as_json_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jmdict_as_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_jmdict_as_json(api_path))
        },
    )
}
fn wire_parse_jndict_as_json_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jndict_as_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_jndict_as_json(api_path))
        },
    )
}
fn wire_parse_kanjidic2_as_json_impl(port_: MessagePort, path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2_as_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_path = path.wire2api();
            move |task_callback| Ok(parse_kanjidic2_as_json(api_path))
        },
    )
}
fn wire_jmdict_to_json_impl(port_: MessagePort, dict: impl Wire2Api<JMDict> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "jmdict_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_dict = dict.wire2api();
            move |task_callback| Ok(jmdict_to_json(api_dict))
        },
    )
}
fn wire_jmdict_entry_to_json_impl(
    port_: MessagePort,
    entry: impl Wire2Api<JMDictEntry> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "jmdict_entry_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_entry = entry.wire2api();
            move |task_callback| Ok(jmdict_entry_to_json(api_entry))
        },
    )
}
fn wire_jndict_to_json_impl(port_: MessagePort, dict: impl Wire2Api<JNDict> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "jndict_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_dict = dict.wire2api();
            move |task_callback| Ok(jndict_to_json(api_dict))
        },
    )
}
fn wire_jndict_entry_to_json_impl(
    port_: MessagePort,
    entry: impl Wire2Api<JNDictEntry> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "jndict_entry_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_entry = entry.wire2api();
            move |task_callback| Ok(jndict_entry_to_json(api_entry))
        },
    )
}
fn wire_kanjidic2_to_json_impl(port_: MessagePort, dict: impl Wire2Api<KD2Dict> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "kanjidic2_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_dict = dict.wire2api();
            move |task_callback| Ok(kanjidic2_to_json(api_dict))
        },
    )
}
fn wire_kanjidic2_header_to_json_impl(
    port_: MessagePort,
    header: impl Wire2Api<KD2DictHeader> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "kanjidic2_header_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_header = header.wire2api();
            move |task_callback| Ok(kanjidic2_header_to_json(api_header))
        },
    )
}
fn wire_kanjidic2_character_to_json_impl(
    port_: MessagePort,
    character: impl Wire2Api<KD2DictCharacter> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "kanjidic2_character_to_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_character = character.wire2api();
            move |task_callback| Ok(kanjidic2_character_to_json(api_character))
        },
    )
}
fn wire_parse_kanjidic2_char_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2_char_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_kanjidic2_char_from_json(api_json))
        },
    )
}
fn wire_parse_kanjidic2_header_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2_header_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_kanjidic2_header_from_json(api_json))
        },
    )
}
fn wire_parse_jmdict_entries_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jmdict_entries_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_jmdict_entries_from_json(api_json))
        },
    )
}
fn wire_parse_jmdict_entry_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jmdict_entry_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_jmdict_entry_from_json(api_json))
        },
    )
}
fn wire_parse_jndict_entries_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jndict_entries_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_jndict_entries_from_json(api_json))
        },
    )
}
fn wire_parse_jndict_entry_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_jndict_entry_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_jndict_entry_from_json(api_json))
        },
    )
}
fn wire_parse_kanjidic2_entries_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2_entries_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_kanjidic2_entries_from_json(api_json))
        },
    )
}
fn wire_parse_kanjidic2_entry_from_json_impl(
    port_: MessagePort,
    json: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "parse_kanjidic2_entry_from_json",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_json = json.wire2api();
            move |task_callback| Ok(parse_kanjidic2_entry_from_json(api_json))
        },
    )
}
...
impl support::IntoDart for JMDict {
    fn into_dart(self) -> support::DartAbi {
        vec![self.0.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDict {}

impl support::IntoDart for JMDictEntry {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.entry_id.into_dart(),
            self.kanji.into_dart(),
            self.reading.into_dart(),
            self.sense.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDictEntry {}

impl support::IntoDart for JMDictExample {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.source.into_dart(),
            self.text.into_dart(),
            self.sentences.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDictExample {}

impl support::IntoDart for JMDictKanji {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.phrase.into_dart(),
            self.info.into_dart(),
...
impl support::IntoDartExceptPrimitive for JMDictKanji {}

impl support::IntoDart for JMDictReading {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.phrase.into_dart(),
            self.no_kanji.into_dart(),
            self.subset.into_dart(),
            self.info.into_dart(),
            self.priority.into_dart(),
        ]
        .into_dart()
...
impl support::IntoDartExceptPrimitive for JMDictReading {}

impl support::IntoDart for JMDictSense {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.restricted_kanji.into_dart(),
            self.restricted_reading.into_dart(),
            self.pos.into_dart(),
            self.xref.into_dart(),
            self.antonym.into_dart(),
            self.field.into_dart(),
            self.misc.into_dart(),
            self.info.into_dart(),
            self.langsource.into_dart(),
            self.dialect.into_dart(),
            self.gloss.into_dart(),
            self.example.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDictSense {}

impl support::IntoDart for JMDictSenseGloss {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.language.into_dart(),
            self.gloss_type.into_dart(),
            self.data.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDictSenseGloss {}

impl support::IntoDart for JMDictSenseLangSource {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.language.into_dart(),
            self.langsource_type.into_dart(),
            self.wasei.into_dart(),
            self.data.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JMDictSenseLangSource {}

impl support::IntoDart for JNDict {
    fn into_dart(self) -> support::DartAbi {
        vec![self.0.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JNDict {}

impl support::IntoDart for JNDictEntry {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.entry_id.into_dart(),
            self.kanji.into_dart(),
            self.reading.into_dart(),
            self.translation.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JNDictEntry {}

impl support::IntoDart for JNDictKanji {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.phrase.into_dart(),
            self.info.into_dart(),
...
impl support::IntoDartExceptPrimitive for JNDictKanji {}

impl support::IntoDart for JNDictReading {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.phrase.into_dart(),
            self.subset.into_dart(),
...
impl support::IntoDartExceptPrimitive for JNDictReading {}

impl support::IntoDart for JNDictTransDet {
    fn into_dart(self) -> support::DartAbi {
        vec![self.language.into_dart(), self.data.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JNDictTransDet {}

impl support::IntoDart for JNDictTranslations {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.name_type.into_dart(),
            self.xref.into_dart(),
            self.transcription.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for JNDictTranslations {}

impl support::IntoDart for KD2Dict {
    fn into_dart(self) -> support::DartAbi {
        vec![self.header.into_dart(), self.characters.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2Dict {}

impl support::IntoDart for KD2DictCharCodePointValue {
    fn into_dart(self) -> support::DartAbi {
        vec![self.data.into_dart(), self.cp_type.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictCharCodePointValue {}

impl support::IntoDart for KD2DictCharRadical {
    fn into_dart(self) -> support::DartAbi {
        vec![self.data.into_dart(), self.rad_type.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictCharRadical {}

impl support::IntoDart for KD2DictCharacter {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.literal.into_dart(),
            self.codepoint.into_dart(),
            self.radical.into_dart(),
            self.misc.into_dart(),
            self.dict_number.into_dart(),
            self.query_code.into_dart(),
            self.reading_meaning.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictCharacter {}

impl support::IntoDart for KD2DictDicNumber {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.dr_type.into_dart(),
            self.m_vol.into_dart(),
            self.m_page.into_dart(),
            self.data.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictDicNumber {}

impl support::IntoDart for KD2DictHeader {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.file_version.into_dart(),
            self.database_version.into_dart(),
            self.date_of_creation.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictHeader {}

impl support::IntoDart for KD2DictMeaning {
    fn into_dart(self) -> support::DartAbi {
        vec![self.data.into_dart(), self.m_lang.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictMeaning {}

impl support::IntoDart for KD2DictMisc {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.grade.into_dart(),
            self.stroke_count.into_dart(),
            self.variant.into_dart(),
            self.freq.into_dart(),
            self.radical_name.into_dart(),
            self.jlpt.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictMisc {}

impl support::IntoDart for KD2DictMiscVariant {
    fn into_dart(self) -> support::DartAbi {
        vec![self.var_type.into_dart(), self.data.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictMiscVariant {}

impl support::IntoDart for KD2DictQueryCode {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.data.into_dart(),
            self.qc_type.into_dart(),
            self.skip_misclass.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictQueryCode {}

impl support::IntoDart for KD2DictReading {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.data.into_dart(),
            self.r_type.into_dart(),
            self.on_type.into_dart(),
            self.r_status.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictReading {}

impl support::IntoDart for KD2DictReadingMeaning {
    fn into_dart(self) -> support::DartAbi {
        vec![self.reading_group.into_dart(), self.nanori.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictReadingMeaning {}

impl support::IntoDart for KD2DictRMGroup {
    fn into_dart(self) -> support::DartAbi {
        vec![self.meaning.into_dart(), self.reading.into_dart()].into_dart()
    }
}
impl support::IntoDartExceptPrimitive for KD2DictRMGroup {}
...
mod web {
    ...
    #[wasm_bindgen]
    pub fn wire_parse_jmdict(port_: MessagePort, path: String) {
        wire_parse_jmdict_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jndict(port_: MessagePort, path: String) {
        wire_parse_jndict_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2(port_: MessagePort, path: String) {
        wire_parse_kanjidic2_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jmdict_as_json(port_: MessagePort, path: String) {
        wire_parse_jmdict_as_json_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jndict_as_json(port_: MessagePort, path: String) {
        wire_parse_jndict_as_json_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2_as_json(port_: MessagePort, path: String) {
        wire_parse_kanjidic2_as_json_impl(port_, path)
    }

    #[wasm_bindgen]
    pub fn wire_jmdict_to_json(port_: MessagePort, dict: JsValue) {
        wire_jmdict_to_json_impl(port_, dict)
    }

    #[wasm_bindgen]
    pub fn wire_jmdict_entry_to_json(port_: MessagePort, entry: JsValue) {
        wire_jmdict_entry_to_json_impl(port_, entry)
    }

    #[wasm_bindgen]
    pub fn wire_jndict_to_json(port_: MessagePort, dict: JsValue) {
        wire_jndict_to_json_impl(port_, dict)
    }

    #[wasm_bindgen]
    pub fn wire_jndict_entry_to_json(port_: MessagePort, entry: JsValue) {
        wire_jndict_entry_to_json_impl(port_, entry)
    }

    #[wasm_bindgen]
    pub fn wire_kanjidic2_to_json(port_: MessagePort, dict: JsValue) {
        wire_kanjidic2_to_json_impl(port_, dict)
    }

    #[wasm_bindgen]
    pub fn wire_kanjidic2_header_to_json(port_: MessagePort, header: JsValue) {
        wire_kanjidic2_header_to_json_impl(port_, header)
    }

    #[wasm_bindgen]
    pub fn wire_kanjidic2_character_to_json(port_: MessagePort, character: JsValue) {
        wire_kanjidic2_character_to_json_impl(port_, character)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2_char_from_json(port_: MessagePort, json: String) {
        wire_parse_kanjidic2_char_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2_header_from_json(port_: MessagePort, json: String) {
        wire_parse_kanjidic2_header_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jmdict_entries_from_json(port_: MessagePort, json: String) {
        wire_parse_jmdict_entries_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jmdict_entry_from_json(port_: MessagePort, json: String) {
        wire_parse_jmdict_entry_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jndict_entries_from_json(port_: MessagePort, json: String) {
        wire_parse_jndict_entries_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_jndict_entry_from_json(port_: MessagePort, json: String) {
        wire_parse_jndict_entry_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2_entries_from_json(port_: MessagePort, json: String) {
        wire_parse_kanjidic2_entries_from_json_impl(port_, json)
    }

    #[wasm_bindgen]
    pub fn wire_parse_kanjidic2_entry_from_json(port_: MessagePort, json: String) {
    ...
    impl Wire2Api<JMDict> for JsValue {
        fn wire2api(self) -> JMDict {
            ...
            JMDict(self_.get(0).wire2api())
        }
    }
    impl Wire2Api<JMDictEntry> for JsValue {
        fn wire2api(self) -> JMDictEntry {
            ...
            JMDictEntry {
                entry_id: self_.get(0).wire2api(),
                kanji: self_.get(1).wire2api(),
                reading: self_.get(2).wire2api(),
                sense: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictExample> for JsValue {
        fn wire2api(self) -> JMDictExample {
            ...
            JMDictExample {
                source: self_.get(0).wire2api(),
                text: self_.get(1).wire2api(),
                sentences: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictKanji> for JsValue {
        fn wire2api(self) -> JMDictKanji {
            ...
            JMDictKanji {
                ...
                info: self_.get(1).wire2api(),
                priority: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictReading> for JsValue {
        fn wire2api(self) -> JMDictReading {
            ...
            JMDictReading {
                phrase: self_.get(0).wire2api(),
                no_kanji: self_.get(1).wire2api(),
                subset: self_.get(2).wire2api(),
                info: self_.get(3).wire2api(),
                priority: self_.get(4).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictSense> for JsValue {
        fn wire2api(self) -> JMDictSense {
            ...
            JMDictSense {
                restricted_kanji: self_.get(0).wire2api(),
                restricted_reading: self_.get(1).wire2api(),
                pos: self_.get(2).wire2api(),
                xref: self_.get(3).wire2api(),
                antonym: self_.get(4).wire2api(),
                field: self_.get(5).wire2api(),
                misc: self_.get(6).wire2api(),
                info: self_.get(7).wire2api(),
                langsource: self_.get(8).wire2api(),
                dialect: self_.get(9).wire2api(),
                gloss: self_.get(10).wire2api(),
                example: self_.get(11).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictSenseGloss> for JsValue {
        fn wire2api(self) -> JMDictSenseGloss {
            ...
            JMDictSenseGloss {
                ...
                gloss_type: self_.get(1).wire2api(),
                data: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<JMDictSenseLangSource> for JsValue {
        fn wire2api(self) -> JMDictSenseLangSource {
            ...
            JMDictSenseLangSource {
                language: self_.get(0).wire2api(),
                langsource_type: self_.get(1).wire2api(),
                wasei: self_.get(2).wire2api(),
                data: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<JNDict> for JsValue {
        fn wire2api(self) -> JNDict {
            ...
            JNDict(self_.get(0).wire2api())
        }
    }
    impl Wire2Api<JNDictEntry> for JsValue {
        fn wire2api(self) -> JNDictEntry {
            ...
            JNDictEntry {
                ...
                kanji: self_.get(1).wire2api(),
                reading: self_.get(2).wire2api(),
                translation: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<JNDictKanji> for JsValue {
    ...
    impl Wire2Api<JNDictReading> for JsValue {
        fn wire2api(self) -> JNDictReading {
            ...
            JNDictReading {
                phrase: self_.get(0).wire2api(),
                subset: self_.get(1).wire2api(),
                info: self_.get(2).wire2api(),
                priority: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<JNDictTransDet> for JsValue {
    ...
    impl Wire2Api<JNDictTranslations> for JsValue {
        fn wire2api(self) -> JNDictTranslations {
            ...
            JNDictTranslations {
                name_type: self_.get(0).wire2api(),
                xref: self_.get(1).wire2api(),
                transcription: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2Dict> for JsValue {
        fn wire2api(self) -> KD2Dict {
            ...
            KD2Dict {
                header: self_.get(0).wire2api(),
                characters: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictCharCodePointValue> for JsValue {
        fn wire2api(self) -> KD2DictCharCodePointValue {
            ...
            KD2DictCharCodePointValue {
                ...
                cp_type: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictCharRadical> for JsValue {
        fn wire2api(self) -> KD2DictCharRadical {
            ...
            KD2DictCharRadical {
                data: self_.get(0).wire2api(),
                rad_type: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictCharacter> for JsValue {
        fn wire2api(self) -> KD2DictCharacter {
            ...
            KD2DictCharacter {
                literal: self_.get(0).wire2api(),
                codepoint: self_.get(1).wire2api(),
                radical: self_.get(2).wire2api(),
                misc: self_.get(3).wire2api(),
                dict_number: self_.get(4).wire2api(),
                query_code: self_.get(5).wire2api(),
                reading_meaning: self_.get(6).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictDicNumber> for JsValue {
        fn wire2api(self) -> KD2DictDicNumber {
            ...
            KD2DictDicNumber {
                dr_type: self_.get(0).wire2api(),
                m_vol: self_.get(1).wire2api(),
                m_page: self_.get(2).wire2api(),
                data: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictHeader> for JsValue {
        fn wire2api(self) -> KD2DictHeader {
            ...
            KD2DictHeader {
                file_version: self_.get(0).wire2api(),
                database_version: self_.get(1).wire2api(),
                date_of_creation: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictMeaning> for JsValue {
        fn wire2api(self) -> KD2DictMeaning {
            ...
            KD2DictMeaning {
                data: self_.get(0).wire2api(),
                m_lang: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictMisc> for JsValue {
        fn wire2api(self) -> KD2DictMisc {
            ...
            KD2DictMisc {
                grade: self_.get(0).wire2api(),
                stroke_count: self_.get(1).wire2api(),
                variant: self_.get(2).wire2api(),
                freq: self_.get(3).wire2api(),
                radical_name: self_.get(4).wire2api(),
                jlpt: self_.get(5).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictMiscVariant> for JsValue {
        fn wire2api(self) -> KD2DictMiscVariant {
            ...
            KD2DictMiscVariant {
                var_type: self_.get(0).wire2api(),
                data: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictQueryCode> for JsValue {
        fn wire2api(self) -> KD2DictQueryCode {
            ...
            KD2DictQueryCode {
                data: self_.get(0).wire2api(),
                qc_type: self_.get(1).wire2api(),
                skip_misclass: self_.get(2).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictReading> for JsValue {
        fn wire2api(self) -> KD2DictReading {
            ...
            KD2DictReading {
                data: self_.get(0).wire2api(),
                r_type: self_.get(1).wire2api(),
                on_type: self_.get(2).wire2api(),
                r_status: self_.get(3).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictReadingMeaning> for JsValue {
        fn wire2api(self) -> KD2DictReadingMeaning {
            ...
            KD2DictReadingMeaning {
                reading_group: self_.get(0).wire2api(),
                nanori: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<KD2DictRMGroup> for JsValue {
        fn wire2api(self) -> KD2DictRMGroup {
            ...
            KD2DictRMGroup {
                meaning: self_.get(0).wire2api(),
                reading: self_.get(1).wire2api(),
            }
        }
    }
    impl Wire2Api<Vec<JMDictEntry>> for JsValue {
    ...
    impl Wire2Api<Vec<JMDictExample>> for JsValue {
    ...
    impl Wire2Api<Vec<JMDictReading>> for JsValue {
    ...
    impl Wire2Api<Vec<JMDictSense>> for JsValue {
    ...
    impl Wire2Api<Vec<JMDictSenseGloss>> for JsValue {
    ...
    impl Wire2Api<Vec<JMDictSenseLangSource>> for JsValue {
    ...
    impl Wire2Api<Vec<JNDictEntry>> for JsValue {
    ...
    impl Wire2Api<Vec<JNDictReading>> for JsValue {
    ...
    impl Wire2Api<Vec<JNDictTransDet>> for JsValue {
    ...
    impl Wire2Api<Vec<JNDictTranslations>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictCharCodePointValue>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictCharRadical>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictCharacter>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictDicNumber>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictMeaning>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictMiscVariant>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictQueryCode>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictReading>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictReadingMeaning>> for JsValue {
    ...
    impl Wire2Api<Vec<KD2DictRMGroup>> for JsValue {
    ...
    impl Wire2Api<Option<JMDictKanji>> for JsValue {
        fn wire2api(self) -> Option<JMDictKanji> {
            (!self.is_undefined() && !self.is_null()).then(|| self.wire2api())
        }
    }
    impl Wire2Api<Option<JNDictKanji>> for JsValue {
        fn wire2api(self) -> Option<JNDictKanji> {
            (!self.is_undefined() && !self.is_null()).then(|| self.wire2api())
        }
    }
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn wire_parse_kanjidic2_header_from_json(
        port_: i64,
    ...
    #[no_mangle]
    pub extern "C" fn wire_parse_kanjidic2_entries_from_json(
        port_: i64,
        json: *mut wire_uint_8_list,
    ) {
        wire_parse_kanjidic2_entries_from_json_impl(port_, json)
    ...
    #[no_mangle]
    pub extern "C" fn wire_parse_kanjidic2_entry_from_json(
        port_: i64,
        json: *mut wire_uint_8_list,
    ) {
        wire_parse_kanjidic2_entry_from_json_impl(port_, json)
    ...
    #[no_mangle]
    pub extern "C" fn new_list_jm_dict_sense_gloss_0(
        len: i32,
    ) -> *mut wire_list_jm_dict_sense_gloss {
    ...
    #[no_mangle]
    pub extern "C" fn new_list_jn_dict_translations_0(
        len: i32,
    ) -> *mut wire_list_jn_dict_translations {
    ...
    pub extern "C" fn new_list_kd_2_dict_char_code_point_value_0(
        ...
        let wrap = wire_list_kd_2_dict_char_code_point_value {
            ptr: support::new_leak_vec_ptr(
                <wire_KD2DictCharCodePointValue>::new_with_null_ptr(),
                len,
            ),
            len,
        };
    ...
    #[no_mangle]
    pub extern "C" fn new_list_kd_2_dict_character_0(
        len: i32,
    ) -> *mut wire_list_kd_2_dict_character {
    ...
    #[no_mangle]
    pub extern "C" fn new_list_kd_2_dict_dic_number_0(
        len: i32,
    ) -> *mut wire_list_kd_2_dict_dic_number {
    ...
    #[no_mangle]
    pub extern "C" fn new_list_kd_2_dict_query_code_0(
        len: i32,
    ) -> *mut wire_list_kd_2_dict_query_code {
